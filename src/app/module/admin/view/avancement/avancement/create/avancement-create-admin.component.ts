...
@Component({
  selector: 'app-avancement-create-admin',
  templateUrl: './avancement-create-admin.component.html'
})
export class AvancementCreateAdminComponent extends AbstractCreateController<AvancementDto, AvancementCriteria, AvancementAdminService>  implements OnInit {
